...
#       changed. 
#
# Usage: 'python3 napalm-single-node-change.py changes.txt'
#
...
device_ip = input("Enter IP address of the host to make changes to: ")
...
commit_config = input("Do you want to commit the changes [Y or N]? ") 
